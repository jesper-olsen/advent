...
impl Obj {
    ...
    pub const fn note(self, prop: i8) -> &'static str {
        match (self, prop) {
            ...
            (Troll, 0) => {
                "A burly troll stands by the bridge and insists you throw him a treasure before you may cross. \u{1F47A}"
            }
            (Troll, 1) => {
                "The troll steps out from beneath the bridge and blocks your way. \u{1F47A}"
            }
            (Bridge, 0) => {
            ...
            (Message, 0) => {
                "There is a message scrawled in the dust in a flowery script, reading: \"This is not the maze where the pirate hides his treasure chest.\""
            }
            ...
            (Plant, 0) => {
                "There is a tiny little plant in the pit, murmuring \'Water, water, ...\" \u{1F33F}"
            }
            (Plant, 1) => "The plant spurts into furious growth for a few seconds. \u{1F33F}",
            (Plant, 2) => {
                "There is a 12-foot-tall beanstalk stretching up out of the pit, bellowing \"Water!! Water!!\" \u{1F33F}"
            }
            (Plant, 3) => {
                "The plant grows explosively, almost filling the bottom of the pit. \u{1F33F}"
            }
            (Plant, 4) => {
                "There is a gigantic beanstalk stretching all the way up to the hole. \u{1F33F}"
            }
            (Plant, 5) => {
                "You've over-watered the plant! It's shriveling up! It's it's... \u{1F33F}"
            }
            ...
            (Rod2, 0) => {
                "A three-foot black rod with a rusty mark on an end lies nearby. \u{1F9E8}"
            }
