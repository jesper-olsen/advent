...
const fn description(loc: Loc) -> Description {
    match loc {
        ...
        | Like12 | Like13 | Like14 => Description {
        ...
        Inhand | Limbo | Scan2 | Scan3 | Ppass | Pdrop | Troll | Sayit0 | Sayit1 | Sayit2
        | Sayit3 | Sayit4 | Sayit5 | Sayit6 | Sayit7 | Sayit8 | Sayit9 | Sayit10 | Sayit11
        | Sayit12 => Description {
            long: "",
            short: "",
            condition: 0,
...
mod tests {
    ...
    fn enum_from_u8_test() {
        for loc in [
            Inhand, Limbo, Road, Hill, House, Valley, Forest, Woods, Slit, Outside, Sayit8, Sayit9,
            Sayit10, Sayit11, Sayit12,
        ] {
